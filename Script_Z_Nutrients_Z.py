...
hybrid_tp = nc.Dataset('/archive/depfg/graha010/Analysis_Of_Nutrients/Hybrid_TP.nc')
...
print('Saving')
data.to_netcdf('/archive/depfg/graha010/Analysis_Of_Nutrients/Hybrid_TP_WithMB.nc')
print('Saved')
