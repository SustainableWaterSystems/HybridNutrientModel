...
for scenario in ['SSP1','SSP2','SSP3','SSP4','SSP5']:
  ...
  hybrid_tp = nc.Dataset('/archive/depfg/graha010/Analysis_Of_Nutrients/FUTURE_' + scenario + '_Hybrid_TP_2011_2015.nc')
  ...
  print('Saving')
  data.to_netcdf('/archive/depfg/graha010/Analysis_Of_Nutrients/FUTURE_' + scenario + '_Hybrid_TP_2011_2015_WithMB.nc')
  print('Saved')
