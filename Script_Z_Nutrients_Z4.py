...
hybrid_tn = nc.Dataset('/archive/depfg/graha010/Analysis_Of_Nutrients/Hybrid_TN.nc')
...
print('Saving')
data.to_netcdf('/archive/depfg/graha010/Analysis_Of_Nutrients/Hybrid_TN_WithMB.nc')
print('Saved')
