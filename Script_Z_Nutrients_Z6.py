...
for scenario in ['SSP1','SSP2','SSP3','SSP4','SSP5']:
  ...
  hybrid_tn = nc.Dataset('/archive/depfg/graha010/Analysis_Of_Nutrients/FUTURE_' + scenario + '_Hybrid_TN.nc')
  ...
  print('Saving')
  data.to_netcdf('/archive/depfg/graha010/Analysis_Of_Nutrients/FUTURE_' + scenario + '_Hybrid_TN_WithMB.nc')
  print('Saved')
