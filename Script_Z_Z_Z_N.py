...
for SSP in ['SSP1','SSP2','SSP3','SSP4','SSP5']:
  ...
  section1 = nc.Dataset('/archive/depfg/graha010/Analysis_Of_Nutrients/FUTURE_' + SSP + '_Hybrid_TN_2011_2015_WithMB.nc')
  section2 = nc.Dataset('/archive/depfg/graha010/Analysis_Of_Nutrients/FUTURE_' + SSP + '_Hybrid_TN_WithMB.nc')
  combined_data = np.concatenate([section1['HybTN_MB'][:,:,:],section2['HybTN_MB'][:,:,:]],axis=0)


  #print(section1['HybTN_MB'].shape)
  #print(section2['HybTN_MB'].shape)
  ...
  data = xarray.DataArray(combined_data, coords=[('time', combined_time), ('lat', lat), ('lon', lon)], name='Nconc')
  ...
  print('Saving')
  ds.to_netcdf('/archive/depfg/graha010/Analysis_Of_Nutrients/Combined_FUTURE_' + SSP + '_Hybrid_Nconc_WithMB.nc')
  print('Saved')
